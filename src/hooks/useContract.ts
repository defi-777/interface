...
import ADAPTER_FACTORY_ABI from '../constants/abis/IAdapterFactory.json'
...
export function useAdapterFactoryContract(address?: string): Contract | null {
  return useContract(address, ADAPTER_FACTORY_ABI, true)
}
